...
import sys
sys.path.append("PoseEstimate/SPPE")
from PoseEstimate.SPPE.src.main_fast_inference import InferenNet_fast, InferenNet_fastRes50
from PoseEstimate.SPPE.src.utils.img import crop_dets
from PoseEstimate.pPose_nms import pose_nms
from PoseEstimate.SPPE.src.utils.eval import getPrediction
